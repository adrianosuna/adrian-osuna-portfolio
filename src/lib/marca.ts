// La marca en un solo sitio: el trazo del monograma AO, vectorizado del PNG maestro
// (`docs/marca/logo-blanco.png`). Sin `server-only` ni React: lo usan UI e iconos.

/** Caja del trazo. La proporción (1,887:1) es la del logo original. */
export const MARCA_ANCHO = 1000
export const MARCA_ALTO = 530

/** Se pinta con `fill-rule: evenodd`: son tres contornos y el tercero es el hueco
 *  de la A. Con `nonzero` la A saldría maciza. */
